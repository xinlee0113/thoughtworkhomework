...
public class TweetFragmentTest {
    FragmentScenario<MomentsFragment> fragmentScenario;
    ...
    @Before
    public void init() {
        fragmentScenario = FragmentScenario.launch(MomentsFragment.class);
    ...
    public void testBindData() {
        fragmentScenario.onFragment(MomentsFragment::bindTweetDataToView);
    }
